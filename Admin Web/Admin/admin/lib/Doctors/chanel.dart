...
// Placeholder for DoctorManagementPage
class DoctorManagementPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Center(
        child: Text('Here you can add, edit, and delete doctor entries.'),
      ),
    );
  }
}
...
class FirestoreService {
  ...
  Future<void> addUser(User user) async {
    await firestore.collection('users').add({
      'name': user.name,
      'hospital': user.username, // Assuming username is used for hospital
      'imageUrl': user.image,
      'info': user.info,
